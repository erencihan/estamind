          ...
          <div className="glass-card rounded-2xl p-4 sm:p-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
              <div className="min-w-0">
                <h1 className="text-xl sm:text-2xl font-dm font-bold">Analiz Sonuçları</h1>
              ...
              <>
                <div className="relative rounded-2xl overflow-hidden mb-8">
                  <div className="absolute inset-0 bg-primary/80 backdrop-blur-sm z-10 flex flex-col items-center justify-center p-8 text-center">
                    ...
                    <h2 className="text-xl font-dm font-bold mb-2">Detaylı sonuçlar Pro veya Elite’te</h2>
            ...
            <>
            <div className="bg-gradient-to-r from-accent/20 to-warning/20 rounded-2xl p-4 sm:p-6 mb-8 border border-accent/30">
              <div className="flex items-start sm:items-center gap-2 mb-4">
                <MapPin className="w-5 h-5 text-accent" />
                <span className="font-dm font-semibold break-words">{formData.city} / {formData.district} m² Fiyat Analizi</span>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-surface-card rounded-2xl p-4 sm:p-6">
              ...
              <div className="bg-surface-card rounded-2xl p-4 sm:p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    <span className="text-white font-mono break-all">₺{((formData.area_sqm * analysisResults.districtAvgPricePerSqm) / 1000000).toFixed(1)}M</span>
                  </div>
                </div>
              </div>
            </div>

            <div className="bg-surface-card rounded-2xl p-4 sm:p-6 mb-6">
            ...
            <div className="bg-surface-card rounded-2xl p-4 sm:p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-gradient-to-r from-success/10 to-transparent rounded-xl border border-success/20">
                  <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-gradient-to-r from-accent/10 to-transparent rounded-xl border border-accent/20">
                  <div>
            ...
            <div className="bg-surface-card rounded-2xl p-4 sm:p-6 mb-8">
            ...
            <div className="bg-surface-card rounded-2xl p-4 sm:p-6 mb-8">
              ...
              <div className="space-y-3">
                {analysisResults.titleSuggestions.map((title, i) => (
                  <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-primary/50 rounded-xl p-4">
                    <span className="break-words">{title}</span>
                    <button className="btn-secondary text-sm py-2 px-3 w-full sm:w-auto" onClick={() => navigator.clipboard.writeText(title)}>Kopyala</button>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Toast */}
            {toastMessage && (
              <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] w-[calc(100vw-2rem)] max-w-md px-6 py-4 rounded-lg bg-success/90 text-primary text-center font-medium shadow-lg">
                {toastMessage}
              </div>
            )}
