      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            EstaMind, emlak profesyonellerinin işini kolaylaştıran akıllı bir analiz platformudur. 
            Sadece mülk bilgilerini girin, yapay zeka size saniyeler içinde profesyonel bir fiyat analizi ve strateji önerileri sunsun.
          </p>
        </motion.div>
        ...
        >
        {[
            { step: '1', title: 'Mülk Bilgisi', desc: 'Konum, m², oda sayısı gibi temel bilgileri girin', icon: <Building2 className="w-8 h-8 text-accent mx-auto mb-3" /> },
            { step: '2', title: 'AI Analizi', desc: 'Yapay zeka bölge verilerini ve pazar trendlerini analiz eder', icon: <Brain className="w-8 h-8 text-accent mx-auto mb-3" /> },
            { step: '3', title: 'Fiyat Önerisi', desc: 'Doğru fiyat aralığı ve alıcı profilleri belirlenir', icon: <TrendingUp className="w-8 h-8 text-accent mx-auto mb-3" /> },
            { step: '4', title: 'Strateji', desc: 'İlan başlığı ve pazarlama önerileri ile satışa hazır', icon: <Target className="w-8 h-8 text-accent mx-auto mb-3" /> },
          ].map((item, i) => (
            <div key={i} className="glass-card rounded-2xl p-6 text-center">
              <div className="w-12 h-12 rounded-full bg-accent/20 flex items-center justify-center text-accent font-bold text-xl mx-auto mb-4">
                {item.step}
              </div>
              {item.icon}
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="bg-surface-card rounded-2xl p-6">
                ...
                <div className="mt-4 h-2 bg-primary rounded-full overflow-hidden">
                  <motion.div 
                    className="h-full bg-gradient-to-r from-success via-accent to-warning"
                    initial={{ width: 0 }}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-accent/20 to-warning/20 flex items-center justify-center text-accent mb-4">
                {feature.icon}
              </div>
          ...
          {plans.map((plan, i) => (
            ...
            >
              ...
              <div className="text-center mb-6 shrink-0">
                <h3 className="text-xl font-outfit font-semibold mb-2">{plan.name}</h3>
              ...
              <a href="/register" className={`w-full py-3 rounded-xl font-semibold transition-all text-center block shrink-0 mt-auto ${
                plan.popular 
                  ? 'btn-primary' 
                  : 'btn-secondary'
              }`}>
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-outfit font-bold">Esta<span className="text-accent">Mind</span></span>
            </div>
            <p className="text-gray-500 text-sm">
              Emlak profesyonelleri için yapay zeka destekli analiz platformu.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-500 text-sm">
              <li><a href="#features" className="hover:text-accent transition-colors">Özellikler</a></li>
              <li><a href="#pricing" className="hover:text-accent transition-colors">Fiyatlandırma</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-500 text-sm">
              ...
              <li><a href="#" className="hover:text-accent transition-colors">KVKK</a></li>
            </ul>
          </div>
        </div>
